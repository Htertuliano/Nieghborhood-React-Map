...
(function(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_1_react_dom__ = __webpack_require__(14);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_1_react_dom___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react_dom__);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_2__index_css__ = __webpack_require__(24);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_2__index_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__index_css__);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_3__App__ = __webpack_require__(25);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_4__registerServiceWorker__ = __webpack_require__(29);
 ...
 */
    ...
    function S(a, b, e) {
        ...
        Array.isArray(a) ? T(a, c, e, p.thatReturnsArgument) : null != a && (K(a) && (b = d + (!a.key || b && b.key === a.key ? "" : ("" + a.key).replace(L, "$\x26/") + "/") + e,
        a = {
            $$typeof: r,
            type: a.type,
            key: b,
...
*/
    ...
    var P = {
        ...
        invokeGuardedCallbackAndCatchFirstError: function(a, b, c, d, e, f, g, h, k) {
            ...
            if (P.hasCaughtError()) {
                ...
                P._hasRethrowError || (P._hasRethrowError = !0,
                P._rethrowError = q)
            }
        },
                ...
                if (!Oa[c]) {
                    ...
                    for (var d in c) {
                        ...
                        if (k) {
                            ...
                            f.registrationName ? (Qa(f.registrationName, g, h),
                            e = !0) : e = !1;
                        e ? void 0 : E("98", d, a)
                    }
                }
    ...
    function Ua(a) {
        ...
        for (c in a)
            if (a.hasOwnProperty(c)) {
                var d = a[c];
                Ma.hasOwnProperty(c) && Ma[c] === d || (Ma[c] ? E("102", c) : void 0,
                Ma[c] = d,
                b = !0)
            }
        b && Na()
    ...
    function hc(a, b) {
        if (fc)
            return "topCompositionEnd" === a || !Vb && dc(a, b) ? (a = Fb(),
            S._root = null,
            S._startText = null,
    ...
    var ic = {
        ...
        extractEvents: function(a, b, c, d) {
            ...
            Ab(f),
            e = f) : e = null;
            (a = Zb ? gc(a, c) : hc(a, c)) ? (b = Nb.getPooled(bc.beforeInput, b, c, d),
            b.data = a,
            Ab(b)) : b = null;
            return [e, b]
        }
    ...
    function Lc() {
        Fc && (Fc.detachEvent("onpropertychange", Mc),
        Gc = Fc = null)
    }
    function Mc(a) {
        "value" === a.propertyName && Ic(Gc) && (a = Ec(Gc, a, wc(a)),
        tc(Hc, a))
    }
    function Nc(a, b, c) {
        "topFocus" === a ? (Lc(),
        Fc = b,
        Gc = c,
        Fc.attachEvent("onpropertychange", Mc)) : "topBlur" === a && Lc()
    }
    function Oc(a) {
    ...
    var ad = {
        ...
        extractEvents: function(a, b, c, d) {
            ...
            if ("select" === f || "input" === f && "file" === e.type)
                ...
                f = e.nodeName,
                !f || "input" !== f.toLowerCase() || "checkbox" !== e.type && "radio" !== e.type || (g = Pc);
            if (g && (g = g(a, b)))
                return Ec(g, c, d);
            h && h(a, e, b);
    ...
    var gd = {
      ...
      , hd = {
        ...
        extractEvents: function(a, b, c, d) {
            ...
            "topMouseOut" === a ? (a = b,
            b = (b = c.relatedTarget || c.toElement) ? pb(b) : null) : a = null;
            if (a === b)
                return null;
            var f = null == a ? e : qb(a);
            e = null == b ? e : qb(b);
    ...
    var zd = {
      ...
      , Ad = {}
      , Bd = {};
    l.canUseDOM && (Bd = document.createElement("div").style,
    "AnimationEvent"in window || (delete zd.animationend.animation,
    ...
    function Hd(a) {
        Object.prototype.hasOwnProperty.call(a, Gd) || (a[Gd] = Fd++,
        Ed[a[Gd]] = {});
        return Ed[a[Gd]]
    }
    function Id(a) {
    ...
    function Rd(a, b) {
        ...
        } : window.getSelection ? (c = window.getSelection(),
        c = {
    ...
    bd.augmentClass(Zd, {
        key: function(a) {
            ...
            return "keypress" === a.type ? (a = Wd(a),
            13 === a ? "Enter" : String.fromCharCode(a)) : "keydown" === a.type || "keyup" === a.type ? Yd[a.keyCode] || "Unidentified" : ""
        },
        location: null,
        ctrlKey: null,
        shiftKey: null,
    ...
    function se(a, b, c) {
        var d = a.alternate;
        null === d ? (d = new Y(a.tag,a.key,a.internalContextTag),
        d.type = a.type,
        d.stateNode = a.stateNode,
        d.alternate = a,
        a.alternate = d) : (d.effectTag = 0,
        d.nextEffect = null,
        d.firstEffect = null,
        d.lastEffect = null);
        d.expirationTime = c;
    ...
    function te(a, b, c) {
        ...
        d.type = e,
        d.pendingProps = a.props) : "string" === typeof e ? (d = new Y(5,f,b),
        d.type = e,
        d.pendingProps = a.props) : "object" === typeof e && null !== e && "number" === typeof e.tag ? (d = e,
    ...
    function Ge(a, b) {
        null === a.last ? a.first = a.last = b : (a.last.next = b,
        a.last = b);
    ...
    function He(a, b) {
        ...
        null !== c ? (a = c.updateQueue,
        null === a && (a = c.updateQueue = Fe(null))) : a = null;
        a = a !== d ? a : null;
        null === a ? Ge(d, b) : null === d.last || null === a.last ? (Ge(d, b),
        Ge(a, b)) : (Ge(d, b),
        a.last = b)
    }
    function Ie(a, b, c, d) {
    ...
    function Je(a, b, c, d, e, f) {
        ...
        c.expirationTime = 0;
        c.isInitialized ? a = c.baseState : (a = c.baseState = b.memoizedState,
        c.isInitialized = !0);
        for (var g = !0, h = c.first, k = !1; null !== h; ) {
            ...
            if (q > f) {
                ...
                null !== h.callback && (q = c.callbackList,
    ...
    function Le(a, b, c, d) {
        ...
        return {
            ...
            mountClassInstance: function(a, b) {
                ...
                "function" === typeof d.componentWillMount && (e = d.state,
            ...
            updateClassInstance: function(a, b, e) {
                ...
                if (!(h !== k || u !== e || X.current || null !== b.updateQueue && b.updateQueue.hasForceUpdate))
                    return "function" !== typeof g.componentDidUpdate || h === a.memoizedProps && u === a.memoizedState || (b.effectTag |= 4),
                    !1;
                var G = k;
    ...
    function af(a) {
        ...
        function h(a, b, c, d) {
            if (null === b || 6 !== b.tag)
                return b = ve(c, a.internalContextTag, d),
                b["return"] = a,
                b;
            b = e(b, c, d);
            b["return"] = a;
        ...
        function q(a, b, c, d) {
            if (null === b || 7 !== b.tag)
                return b = we(c, a.internalContextTag, d),
                b["return"] = a,
                b;
            b = e(b, c, d);
            b["return"] = a;
        ...
        function v(a, b, c, d) {
            if (null === b || 9 !== b.tag)
                return b = xe(c, a.internalContextTag, d),
                b.type = c.value,
                b["return"] = a,
                b;
            b = e(b, null, d);
        ...
        function y(a, b, c, d) {
            if (null === b || 4 !== b.tag || b.stateNode.containerInfo !== c.containerInfo || b.stateNode.implementation !== c.implementation)
                return b = ye(c, a.internalContextTag, d),
                b["return"] = a,
                b;
            b = e(b, c.children || [], d);
            b["return"] = a;
        ...
        function u(a, b, c, d, f) {
            if (null === b || 10 !== b.tag)
                return b = ue(c, a.internalContextTag, d, f),
                b["return"] = a,
                b;
            b = e(b, c, d);
            b["return"] = a;
        ...
        function z(a, b, c) {
            if ("string" === typeof b || "number" === typeof b)
                return b = ve("" + b, a.internalContextTag, c),
                b["return"] = a,
                b;
            if ("object" === typeof b && null !== b) {
                ...
                case Re:
                    if (b.type === Ve)
                        return b = ue(b.props.children, a.internalContextTag, c, b.key),
                        b["return"] = a,
                        b;
                    ...
                    return c;
                case Se:
                    return b = we(b, a.internalContextTag, c),
                    b["return"] = a,
                    b;
                case Te:
                    return c = xe(b, a.internalContextTag, c),
                    c.type = b.value,
                    c["return"] = a,
                    c;
                case Ue:
                    return b = ye(b, a.internalContextTag, c),
                    b["return"] = a,
                    b
                }
                if (Ye(b) || Xe(b))
                    return b = ue(b, a.internalContextTag, c, null),
                    b["return"] = a,
                    b;
                $e(a, b)
            }
        ...
        function I(a, b, c, d, e) {
            ...
            if ("object" === typeof d && null !== d) {
                ...
                case Re:
                    ...
                    d.type === Ve ? u(b, a, d.props.children, e, d.key) : k(b, a, d, e);
                case Se:
                    return a = a.get(null === d.key ? c : d.key) || null,
                    q(b, a, d, e);
                case Te:
        ...
        function N(e, g, m, A) {
            ...
            for (n = d(e, n); !x.done; w++,
            x = m.next())
                if (x = I(n, e, w, x.value, A),
                null !== x) {
        ...
        return function(a, d, f, h) {
            ...
            if (m)
                ...
                case Re:
                    a: {
                        ...
                        f.type === Ve ? (d = ue(f.props.children, a.internalContextTag, h, f.key),
                        d["return"] = a,
                        a = d) : (h = te(f, a.internalContextTag, h),
                        h.ref = Ze(d, f),
                        h["return"] = a,
                        a = h)
                    }
            ...
            if ("undefined" === typeof f)
                ...
                case 1:
                    h = a.type,
                    E("152", h.displayName || h.name || "Component")
                }
            return c(a, d)
        }
    }
        ...
        return {
            beginWork: function(a, b, c) {
                ...
                case 2:
                    return e = qe(b),
                    d = void 0,
                    null === a ? b.stateNode ? E("153") : (m(b, b.pendingProps),
                    A(b, c),
                    d = !0) : d = Ob(a, b, c),
                    h(a, b, d, e);
                case 3:
                    ...
                    b = q(a, b)) : (d = e.element,
                    r = b.stateNode,
                    (null === a || null === a.child) && r.hydrate && L(b) ? (b.effectTag |= 2,
                    b.child = cf(b, null, d, c)) : (N(),
                    f(a, b, d)),
                    b.memoizedState = e,
                    b = b.child)) : (N(),
                    b = q(a, b)),
                ...
                case 5:
                    ...
                    X.current || null !== d && n !== d ? (n = d.children,
                    y(e, d) ? n = null : r && y(e, r) && (b.effectTag |= 16),
                    g(a, b),
                    2147483647 !== c && !u && z(e, d) ? (b.expirationTime = 2147483647,
                    b = null) : (f(a, b, n),
                    b.memoizedProps = d,
                    b = b.child)) : b = q(a, b);
                    return b;
            ...
            completeWork: function(a, b, c) {
                ...
                case 5:
                    ...
                    if (null !== a && null != b.stateNode) {
                        ...
                        if (!m)
                            return null === b.stateNode ? E("166") : void 0,
                            null;
                        a = u();
                        if (L(b))
                            G(b, c, a) && d(b);
    ...
    function ff(a, b) {
        ...
        function g(a) {
            for (var b = a, c = !1, f = void 0, g = void 0; ; ) {
                ...
                if (5 === b.tag || 6 === b.tag)
                    e(b),
                    g ? J(f, b.stateNode) : N(f, b.stateNode);
                else if (4 === b.tag ? f = b.stateNode.containerInfo : d(b),
                null !== b.child) {
                    b.child["return"] = b;
                    b = b.child;
                    continue
        ...
        return {
            ...
            commitDeletion: function(a) {
                ...
                a["return"] = null;
                a.child = null;
                a.alternate && (a.alternate.child = null,
    ...
    function kf(a) {
                ...
                try {
                    for (; null !== t; ) {
                        ...
                        if (k & 64)
                            ...
                            null !== R && (f = R.get(e),
                            R["delete"](e),
                            null == f && null !== e.alternate && (e = e.alternate,
                            f = R.get(e),
                            R["delete"](e))),
                            null == f ? E("184") : void 0,
                            e.tag) {
            ...
            for (; ; ) {
                ...
                if (2147483647 === H || 2147483647 !== e.expirationTime) {
                    ...
                    for (var g = e.child; null !== g; )
                        0 !== g.expirationTime && (0 === f || f > g.expirationTime) && (f = g.expirationTime),
                        g = g.sibling;
                    e.expirationTime = f
                }
                if (null !== b)
                    return b;
                null !== c && (null === c.firstEffect && (c.firstEffect = a.firstEffect),
        ...
        function h(a, b) {
            ...
            if (3 === a.tag)
                ...
                for (var g = a["return"]; null !== g && null === c; ) {
                    2 === g.tag ? "function" === typeof g.stateNode.componentDidCatch && (d = !0,
                    f = jd(g),
                    c = g,
                    e = !0) : 3 === g.tag && (c = g);
                    if (q(g)) {
                ...
                if (null === a["return"])
                    if (3 === a.tag) {
                        ...
                        if (null === d.nextScheduledRoot)
                            ...
                            null === O ? (sa = O = d,
                            d.nextScheduledRoot = d) : (O = O.nextScheduledRoot = d,
        ...
        function m(a, c) {
            ...
            if (c <= I()) {
                ...
                null !== d ? (a.finishedWork = null,
                a.remainingExpirationTime = b(d)) : (a.finishedWork = null,
                d = g(a, c),
                ...
                a.remainingExpirationTime = b(d)) : (a.finishedWork = null,
                d = g(a, c),
                null !== d && (A() ? a.finishedWork = d : a.remainingExpirationTime = b(d)));
            Fa = !1
        }
        function A() {
    ...
    function Of(a, b) {
        ...
        if (null != c)
            if (0 === c && "" === a.value)
                ...
                if (b = parseFloat(a.value) || 0,
                c != b || c == b && a.value != c)
                    a.value = "" + c
            } else
                a.value !== "" + c && (a.value = "" + c);
        else
            null == b.value && null != b.defaultValue && a.defaultValue !== "" + b.defaultValue && (a.defaultValue = "" + b.defaultValue),
    ...
    function Vf(a, b) {
        ...
        b = b.children,
        null != b && (null != c ? E("92") : void 0,
        Array.isArray(b) && (1 >= b.length ? void 0 : E("93"),
        b = b[0]),
        c = "" + b),
        null == c && (c = ""));
        a._wrapperState = {
    ...
    function hg(a, b, c) {
        ...
        null != b.dangerouslySetInnerHTML && (null != b.children ? E("60") : void 0,
        "object" === typeof b.dangerouslySetInnerHTML && "__html"in b.dangerouslySetInnerHTML ? void 0 : E("61")),
    ...
    function lg(a, b) {
        ...
        for (var d = 0; d < b.length; d++) {
            ...
            wd("topBlur", "blur", a),
            c.topBlur = !0,
            c.topFocus = !0) : "topCancel" === e ? (yc("cancel", !0) && wd("topCancel", "cancel", a),
            c.topCancel = !0) : "topClose" === e ? (yc("close", !0) && wd("topClose", "close", a),
            c.topClose = !0) : Dd.hasOwnProperty(e) && U(e, Dd[e], a),
            c[e] = !0)
        }
    }
    var mg = {
    ...
    function ng(a, b, c, d) {
        ...
        d === jg && (d = Zf(a));
        d === jg ? "script" === a ? (a = c.createElement("div"),
        ...
        for (g in d) {
            ...
            if (d.hasOwnProperty(g) && k !== b && (null != k || null != b))
                if ("style" === g)
                    if (b) {
                        for (h in b)
                            !b.hasOwnProperty(h) || k && k.hasOwnProperty(h) || (a || (a = {}),
                            a[h] = "");
                        for (h in k)
                            k.hasOwnProperty(h) && b[h] !== k[h] && (a || (a = {}),
                            a[h] = k[h])
                    } else
                        a || (f || (f = []),
                        f.push(g, a)),
                    ...
                    "dangerouslySetInnerHTML" === g ? (k = k ? k.__html : void 0,
                    b = b ? b.__html : void 0,
                    null != k && b !== k && (f = f || []).push(g, "" + k)) : "children" === g ? b === k || "string" !== typeof k && "number" !== typeof k || (f = f || []).push(g, "" + k) : "suppressContentEditableWarning" !== g && "suppressHydrationWarning" !== g && (Ra.hasOwnProperty(g) ? (null != k && lg(e, g),
    ...
    function tg(a, b, c, d, e) {
        ...
        case "select":
            ...
            c = e.value,
            null != c ? Sf(a, !!e.multiple, c, !1) : b !== !!e.multiple && (null != e.defaultValue ? Sf(a, !!e.multiple, e.defaultValue, !0) : Sf(a, !!e.multiple, e.multiple ? [] : "", !1))
        }
    }
    function ug(a, b, c, d, e) {
        ...
        d = null;
        for (var g in c)
            c.hasOwnProperty(g) && (f = c[g],
            "children" === g ? "string" === typeof f ? a.textContent !== f && (d = ["children", f]) : "number" === typeof f && a.textContent !== "" + f && (d = ["children", "" + f]) : Ra.hasOwnProperty(g) && null != f && lg(e, g));
        switch (b) {
        case "input":
            Bc(a);
            Pf(a, c);
                ...
                if (Kd(c))
                    ...
                    "selectionStart"in c)
                        ...
                        if (e && f && (1 !== b.rangeCount || b.anchorNode !== e.node || b.anchorOffset !== e.offset || b.focusNode !== f.node || b.focusOffset !== f.offset)) {
                            ...
                            b.removeAllRanges();
                            a > d ? (b.addRange(g),
                            b.extend(f.node, f.offset)) : (g.setEnd(f.node, f.offset),
                            b.addRange(g))
                        }
                    }
                b = [];
...
(function(module, __webpack_exports__, __webpack_require__) {
    ...
    var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_1__App_css__ = __webpack_require__(26);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_1__App_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__App_css__);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_2__Components_Map__ = __webpack_require__(27);
    /* harmony import */
    var __WEBPACK_IMPORTED_MODULE_3__Components_Sidebar__ = __webpack_require__(28);
    ...
    var App = function(_Component) {
        ...
        function App(props) {
            ...
            _this.generateMarkers = _this.generateMarkers.bind(_this);
            _this.openMarker = _this.openMarker.bind(_this);
            return _this;
        }
        _createClass(App, [{
            ...
            key: 'generateMarkers',
            value: function generateMarkers(map) {
                var _this2 = this;
                var self = this;
                this.state.markers.forEach(function(marker) {
                    ...
                    var virtMarker = _this2.state.virtualMarkers;
            ...
            key: 'openMarker',
            value: function openMarker() {
                var marker = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
                var clientId = "VVPEFJC40SJDVH1YFRJS4IBNQ0GGZJY5X1XLHEA23H1LTVOQ\n";
                var clientSecret = "MEAM2N42L434P1MB1AJZFUHM5XAGMCDNGETUH5XNZIYEHOKI\n";
            ...
            key: 'markerInfo',
            value: function markerInfo(url) {
                var self = this.state.info;
                var place = void 0;
                fetch(url).then(function(resp) {
                    if (resp.status !== 200) {
                        var err = "Can't load data.";
                        this.setState({
                            info: err
                        });
                    }
                    resp.json().then(function(data) {
                        ...
                        var info = "<div id='marker'>" + "<h2>" + self.marker.title + "</h2>" + phone + twitter + "<p><b>Address:</b> " + place.location.address + ", " + place.location.city + "</p>" + "</div>";
                        self.setContent(info);
                    });
                    console.log(place);
                }).catch(function(err) {
                    var error = "Can't load data.";
            ...
            value: function render() {
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('header', null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Components_Sidebar__["a"/* default */
                ], {
                    ...
                    id: 'title'
                }, 'Coffee Around the A')), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__Components_Map__["a"/* default */
                ], {
    ...
    var Sidebar = function(_Component) {
        ...
        function Sidebar() {
            ...
            _this.search = function(event) {
                ...
                var markers = _this.props.virtualMarker;
                var newMarkers = [];
        ...
        _createClass(Sidebar, [{
            ...
            key: 'openMarker',
            value: function openMarker(marker) {
                console.log(marker);
            ...
            value: function render() {
                ...
                return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', null, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
                    className: 'veggieburgers',
                    onClick: this.open
                }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
                    className: 'veggieline'
                }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
                    className: 'veggieline'
                }), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('div', {
                    className: 'veggieline'
                ...
                })), __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('ul', null, this.state.markers && this.state.markers.length && this.state.markers.map(function(marker, i) {
                    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('li', {
                        key: i
                    }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('a', {
                        href: '#',
                        onKeyPress: _this2.props.openInfo.bind(_this2, marker),
                        onClick: _this2.props.openInfo.bind(_this2, marker),
                        tabIndex: '0',
                        role: 'button'
                    }, marker.title));
                }))));
...
(function(module, __webpack_exports__, __webpack_require__) {
    ...
    function checkValidServiceWorker(swUrl) {
        ...
        fetch(swUrl).then(function(response) {
            ...
            var changeStatus = document.getElementById('title');
